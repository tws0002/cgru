...
class Tray(QtWidgets.QSystemTrayIcon):
	def __init__(self, parent=None):
		...
		action.triggered.connect(render.setUserDialog)
		...
		action = QtWidgets.QAction('Exit Render', self)
		action.triggered.connect(cmd.exitRender)
		self.menu['AFANASY'].addAction(action)

		action = QtWidgets.QAction('Exit Watch', self)
		action.triggered.connect(cmd.exitMonitor)
		self.menu['AFANASY'].addAction(action)

		action = QtWidgets.QAction('Exit All Clients', self)
		action.triggered.connect(cmd.exitClients)
		self.menu['AFANASY'].addAction(action)
